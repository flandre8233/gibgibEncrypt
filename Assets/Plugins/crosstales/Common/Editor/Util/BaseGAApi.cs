...
#else
        private static readonly int cpuFrequency = 0;
        private static readonly string productName = "UNKNOWN PRODUCT";
        private static readonly string companyName = "UNKNOWN COMPANY";
#endif
